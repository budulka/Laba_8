...
void calculateRLC1(complex *Numerator, complex *Denominator, RLC_Circuit circuit1) {
    ...
    Denominator->imag = (circuit1.angularFrequency * circuit1.inductance - (1.0 / (circuit1.angularFrequency * circuit1.capacitance)));
}
...
void calculateRLC2(complex *Numerator, complex *Denominator, RLC_Circuit circuit2) {
    ...
    Denominator->imag = (circuit2.angularFrequency * circuit2.inductance - (1.0 / (circuit2.angularFrequency * circuit2.capacitance)));
}

void calculateRLC3(complex *Numerator, complex *Denominator, RLC_Circuit circuit3) {
    Numerator->real = circuit3.resistance[0] * circuit3.resistance[1];
    Numerator->imag = circuit3.resistance[0] *
                      (circuit3.angularFrequency * circuit3.inductance - (1.0 / (circuit3.angularFrequency * circuit3.capacitance)));
    Denominator->real = circuit3.resistance[0] + circuit3.resistance[1];
    Denominator->imag = (circuit3.angularFrequency * circuit3.inductance - (1.0 / (circuit3.angularFrequency * circuit3.capacitance)));
}
...
void calculateRLC4(complex *Numerator, complex *Denominator, RLC_Circuit circuit4) {
    ...
    Denominator->imag = (circuit4.angularFrequency * circuit4.inductance - (1.0 / (circuit4.angularFrequency * circuit4.capacitance)));
}
...
void text() {
    printf("This program calcultates the reactive resistance of one of 4 RLC circuits"
           "The first circuit contains 1 resistor, 1 inductor and 1 capacitor"
           "The second circuit contains");
}
